---
description: Prefer the local Superpowerz skill workflow for non-trivial README changes.
applyTo: "README.md"
---

For non-trivial edits to `README.md`, prefer the local Superpowerz skill suite instead of ad hoc execution.

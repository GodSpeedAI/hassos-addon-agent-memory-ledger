---
description: Prefer the local Superpowerz skill workflow for non-trivial backup and restore documentation changes.
applyTo: "BACKUP-RESTORE-IMPLEMENTATION.md"
---

For non-trivial edits to `BACKUP-RESTORE-IMPLEMENTATION.md`, prefer the local Superpowerz skill suite instead of ad hoc execution.

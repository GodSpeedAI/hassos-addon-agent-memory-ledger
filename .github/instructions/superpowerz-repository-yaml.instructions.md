---
description: Prefer the local Superpowerz skill workflow for non-trivial repository.yaml changes.
applyTo: "repository.yaml"
---

For non-trivial edits to `repository.yaml`, prefer the local Superpowerz skill suite instead of ad hoc execution.

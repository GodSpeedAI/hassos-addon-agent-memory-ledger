...
```bash
docker pull ghcr.io/godspeedai/agent-memory-ledger/amd64:0.3.0
docker pull ghcr.io/godspeedai/agent-memory-ledger/aarch64:0.3.0
```
...
docker run \
  ...
  -p 5432:5432 \
  ghcr.io/godspeedai/agent-memory-ledger/amd64:0.3.0
```
